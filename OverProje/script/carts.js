...
displayData(dataLights)
 function displayData(dataLights){
  ...
  function showTotal(){
     ...
     document.getElementById("discount").textContent= "  Promotions Applied"+" :-"+"0"
    }
    showTotal()
    // //coupan func//
     ...
     document.querySelector("#total").innerText="Your Total:"+" :-"+" "+total
     ...
     document.querySelector("#discount").innerText= "Discounts Rs."+" :-" + dis
    ...
    function increaseQuant(index) {
         ...
         console.log(dataLights)
         localStorage.setItem("cartItem",JSON.stringify(dataLights))
